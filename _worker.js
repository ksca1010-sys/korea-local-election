...
<meta property="og:image" content="https://korea-local-election.pages.dev/og-image-v2.png">
...
<meta name="twitter:image" content="https://korea-local-election.pages.dev/og-image-v2.png">
</head>
<body></body>
</html>`;

// KakaoTalk in-app browser user agents can include KakaoTalk/KAKAOTALK.
// Only the KakaoTalk-Scrap preview crawler should receive OG-only HTML.
const SOCIAL_BOT_PATTERN = /facebookexternalhit|Facebot|Twitterbot|LinkedInBot|WhatsApp|Slackbot|Discordbot|KakaoTalk-Scrap/i;
